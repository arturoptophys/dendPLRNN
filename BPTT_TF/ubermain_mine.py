...
def ubermain(n_runs):
    ...
    """
    args = []
    #args.append(Argument('experiment', ['TestRunActialData']))
    #args.append(Argument('data_path', ['/home/artur.schneider/Data2Test/datasets/M003_201111_1_kernels10_croped.npy']))
    ...
    args.append(Argument('data_path', ['/home/artur.schneider/Data2Test/datasets/BEHRat480_190823_res30_kernelS_4_trafo_Local_norm_1.npy']))
    ...
    args.append(Argument('seq_len', [500], add_to_name_as="T"))      #200 -500 is a good heuristic
